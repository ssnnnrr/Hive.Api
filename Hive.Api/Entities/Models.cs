...
namespace Hive.Api.Entities
{
    ...
    public class Notification
    {
        ...
        // ЭТИ ПОЛЯ ИЩУТ ВАШИ КОНТРОЛЛЕРЫ:
    ...
    // Вспомогательные сущности для чатов и событий
    public class Group
    {
        [Key] public long Id { get; set; }
    ...
    public class ChatMessage
    {
        ...
        // Новое: возможность закрепить сообщение
    ...
    public class Event
    {
        ...
        // Новые поля для визуализации и материалов
        public string? LinkUrl { get; set; }  // Ссылка (опционально)
        public string? Location { get; set; } // Место (опционально)
        public string? ImageUrl { get; set; } // Фото в формате Base64 (опционально)
